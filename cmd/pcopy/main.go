...
func usage() {
	...
	fmt.Println()
	fmt.Println("  pcopy copy [-config CONFIG] [-server myhost.com] [[ALIAS:]FILE]")
	fmt.Println("    Read from STDIN and copy to remote clipboard. FILE is the remote file name, and ALIAS is")
