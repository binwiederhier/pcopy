...
# Time in seconds that the authorization for copy/paste requests is valid.
# This is a security setting to prevent replay attacks. Shorter is better. 
#
# Format:  Integer
# Default: 60
#
{{if .MaxRequestAge}}MaxRequestAge {{.MaxRequestAge}}{{else}}# MaxRequestAge 60{{end}}

# Time in seconds that the authorization for join requests is valid.
# This defined how long the command generated by 'pcopy invite' is valid for.
#
# Format:  Integer
# Default: 3600
#
{{if .MaxJoinAge}}MaxJoinAge {{.MaxJoinAge}}{{else}}# MaxJoinAge 3600{{end}}
